...
**Referral Configuration** (if referral system is implemented):
- T1 Commission: % (from `REFERRAL_COMMISSION_T1`)
- T2 Commission: % (from `REFERRAL_COMMISSION_T2`)
- T3 Commission: % (from `REFERRAL_COMMISSION_T3`)
