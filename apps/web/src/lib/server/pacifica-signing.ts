 ...
 */
export function signBuilderCodeApproval(
  keypair: nacl.SignKeyPair,
  builderCode: string,
  maxFeeRate: string
): Record<string, unknown> {
...
export function signMarketOrder(
  ...
  return signRequest(keypair, 'create_market_order', data);
}
...
export function signLimitOrder(
  ...
  return signRequest(keypair, 'create_order', data);
}
...
export function signCancelOrder(
  ...
  return signRequest(keypair, 'cancel_order', data);
}

/**
 * Sign a cancel all orders request
 */
export function signCancelAllOrders(
  keypair: nacl.SignKeyPair,
  params: {
    allSymbols: boolean;
  ...
  return signRequest(keypair, 'cancel_all_orders', data);
}
...
export function signUpdateLeverage(
  ...
  return signRequest(keypair, 'update_leverage', {
    symbol: params.symbol,
